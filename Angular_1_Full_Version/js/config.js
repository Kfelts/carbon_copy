...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $stateProvider
      ...
      .state("common.simple", {
        url: "common/simple",
        templateUrl: "common/simple.html",
        data: {
          pageTitle: "Simple",
        },
        resolve: {
      ...
      .state('contacts.leads', {
        url: "/leads",
        templateUrl: "views/contact_lead_list.html",
        data: {
      ...
      .state('contacts.people', {
            url: "/people",
            templateUrl: "views/contacts_people.html",
            data: {
                pageTitle: 'Contacts People'
            }
        })
        .state('contacts.person_details', {
            url: '/details/person/:id',
            templateUrl: 'views/contacts_person_details.html',
            data: {
                pageTitle: 'Contacts Person Details'
            }
        })
        .state('contacts.companies', {
            url: "/companies",
            templateUrl: "views/contacts_companies.html",
            data: {
                pageTitle: 'Contacts Companies'
            }
        })
        .state('contacts.company_details', {
            url: '/details/company/:id',
            templateUrl: 'views/contacts_company_details.html',
            data: {
                pageTitle: 'Contacts Company Details'
            },
            resolve: {
                loadPlugin: function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
        ...
        .state('contacts.contact_types', {
            url: "/contact_types",
            templateUrl: "views/contacts_types.html",
            data: {
          ...
          loadPlugin: function ($ocLazyLoad) {
            return $ocLazyLoad.load([
              ...
              },
              {
                name: "ngTagsInput",
                files: [
                  "js/plugins/ngTags//ng-tags-input.min.js",
                  "css/plugins/ngTags/ng-tags-input-custom.min.css",
                ],
              },
              {
                files: [
