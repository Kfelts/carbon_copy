            ...
            return {
                ...
                controller: ["$scope", "$timeout", "$attrs", function($scope, $timeout, $attrs) {
                    ...
                    $document.on(
                        ...
                        function(event) {
                            console.log("keydown keypress paste", event.which);
                            ...
                            // var element = angular.element(document.querySelector( "#topEditorLead"));
                            // if(element) {
                            ...
                            // $scope.formData1.description = "s";
                            //     console.log("element")
                            // });
                            // $scope.$parent.formData1.description = "Keith";

                            // }, 500);
                            //
                            // }
                            // $scope.$broadcast('iframeElement', { event: event });
                        }
                ...
                link: function(scope, element, attrs, $scope) {
                    ...
                    angular.extend(scope.options, {
                        keyHandlerFunction: function(event, $scope) {
                            console.log("keyHandlerFunction was called");
                            // $scope.bridgeSearch(event);$
                            var element = angular.element(document.querySelector("#topEditorLead"));
                            if (element) {
                                console.log("element", element)
                    ...
                    scope.$watch(
                        'iframeElement',
                        function(newValue) {
                            console.log("iframeElement", newValue);
                            if (newValue && newValue.contentWindow) {
                                // var iframeDocument = newValue.contentWindow.document;
                                var iframeDocument = angular.element(document.querySelector("#topEditorLead"));
