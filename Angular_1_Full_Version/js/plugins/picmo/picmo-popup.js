(function(T, b) {
    ...
    const xt = async (t, e, n) => {
        ...
        for (let p = 0; p < r.length; p++) {
            ...
            if (a = y != null ? y : a, h = g != null ? g : h, u = { ...u,
                    [d]: { ...u[d],
                        ...x
                    }
                }, process.env.NODE_ENV !== "production" && m > 50 && console.warn(["Floating UI: The middleware lifecycle appears to be running in an", "infinite loop. This is usually caused by a `reset` continually", "being returned without a break condition."].join(" ")), v && m <= 50) {
                ...
                if (P = [...P, {
                    ...
                    switch (u) {
                        case "bestFit":
                            {
                                var J;
                                const _ = (J = P.map(F => [F, F.overflows.filter(R => R > 0).reduce((R, W) => R + W, 0)]).sort((F, R) => F[1] - R[1])[0]) == null ? void 0 : J[0].placement;_ && (V = _);
                                break
                            }
    ...
    class vt {
        constructor(e, n) {
            this.isOpen = !1, this.externalEvents = new b.Events, this.options = { ...te(n),
                ...b.getOptions(e)
            ...
            this.popupEl.appendChild(i), this.picker = b.createPicker({ ...this.options,
                ...
                var o;
                this.close(), (o = this.options.triggerElement) == null || o.focus()
